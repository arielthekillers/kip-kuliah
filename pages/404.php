...
<div class="flex flex-col items-center justify-center min-h-[70vh] text-center px-4">
    <h1 class="text-9xl font-bold text-primary-500 mb-4 drop-shadow-lg">404</h1>
    <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-4">Halaman Tidak Ditemukan</h2>
    <p class="text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto">Maaf, halaman yang Anda cari tidak ada, telah dihapus, atau namanya diubah.</p>
